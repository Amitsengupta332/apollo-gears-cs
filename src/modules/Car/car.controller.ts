...
const findCarById = catchAsync(async (req, res) => {
  const { id } = req.params;
  const result = await CarService.findCarById(id as string);
...
const updateCarById = catchAsync(async (req, res) => {
  const { id } = req.params;
  const result = await CarService.updateCarById(id as string, req.body);
...
const deleteCarById = catchAsync(async (req, res) => {
  const { id } = req.params;
  const result = await CarService.deleteCarById(id as string);
