...
const findBidById = catchAsync(async (req, res) => {
  const { id } = req.params;
  const result = await BidService.findBidById(id as string);
...
const updateBidById = catchAsync(async (req, res) => {
  ...
  const result = await BidService.updateBidById(id as string, req.body);
...
const deleteBidById = catchAsync(async (req, res) => {
  const { id } = req.params;
  const result = await BidService.deleteBidById(id as string);
